                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <ul class="nav nav-pills">
                                       ...
                                       <li><a href="#berkas" data-toggle="tab"><i class="fa fa-folder"></i> KOMITE</a>
                                        </li>
                                         <li><a href="#settings" data-toggle="tab"> <i class="fa fa-certificate"></i> SERTFIKAT</a>
                                        </li>
                                    </ul>
                                    ...
                                    <div class="tab-content">
                                      ...
                                      <div class="tab-pane fade" id="berkas">
                                            <div class="panel panel-primary">
                                                <div class="panel-body">
                                                <?php  include '../dokumen/komite.produktif.php'; ?>
                                                </div>
                                            </div>
                                        </div> 
                                        ...
                                        <div class="panel panel-primary">
                                           <div class="panel-body">
                                           <?php  include '../dokumen/sertifikat.produktif.php'; ?>
                                         </div>
                                        </div>
                                    </div>
