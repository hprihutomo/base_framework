<?php 
  ...
  if (isset($_POST['tidak'])) {
  		$query = "UPDATE MSPERMOHONAN SET DIRUM = '2' WHERE IDPERMOHONAN = $id";
  		$stmt = $db->prepare($query);
  		$stmt->execute();
  }
  if (isset($_POST['lanjut'])) {
  		$query = "UPDATE MSPERMOHONAN SET DIRUM = '1' WHERE IDPERMOHONAN = $id";
  		$stmt = $db->prepare($query);
  		$stmt->execute();
  }
...
<div class="panel panel-primary">
	<div class="panel-heading">DIREKTUR UMUM</div>
