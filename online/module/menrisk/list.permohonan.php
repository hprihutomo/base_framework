<div class="row">
	<div class="col-lg-12">
		...
		<table class='table table-bordered table-condensed' id="mytable">
	        ...
	        <tbody>
	        <?php
	        	$query = "SELECT * FROM DATA_PERMOHONAN WHERE STATUSPERMOHONAN  = 'DIPERIKSA'";
	        ...
	        ?>
	            <tr>
	                ...
	                <td class="text-center">
	                	...
	                	<a href="javascript:void(0)" onclick="Popup('module/menrisk/list.penjaminan.php?id=<?php echo $value['IDPERMOHONAN'] ?>', '', '1366','700')" class="btn btn-success btn-xs"><i class="fa fa-users"></i> NASABAH </a>
