			...
			<tbody>
				<tr>
					<td colspan="2" class="text-center">
						<a href="javascript:void(0)" onclick="Popup('../../module/bank/search.nasabah.php?prdk=<?php echo $idproduk; ?>', '', '800','400')" class="btn btn-sm btn-info"><i class="fa fa-check"></i> PILIH NASABAH</a>
					</td>
				</tr>
				<tr>
					<td>NO. IDENTITAS</td>
...
<div class="col-lg-4">
	<table class="table table-condensed table-bordered">
		<tbody>
			...
			<tr>
				<td>IMBAL JASA</td>
				<td><input type="text"  name="ijp" id="ijp" autocomplete="off" ></td>
			</tr>
			<tr>
				<td>TARIF JIWA(%)</td>
				<td><input type="text" name="p_ijpjiwa" id="p_ijpjiwa"></td>
			</tr>
			<tr>
				<td>IMBAL JASA JIWA</td>
				<td><input type="text" name="ijpjiwa" id="ijpjiwa"></td>
			</tr>
		</tbody>
	</table>
</div>
...
<div class="col-lg-4">
	<table class="table table-condensed table-bordered">
		<tbody>
			...
			<tr>
				<td>PENGGUNAAN</td>
				<td><textarea name="penggunaan" id="penggunaan"></textarea></td>
			</tr>
			<tr>
				<td>DESKRIPSI</td>
...
<!-- <tr>
				...
				<!-- <tr>
					<td>NO. IDENTITAS</td>
					<td>
						<input type="text" class="form-control input-sm" autofocus="true" 
							<?php if ($_GET['act'] == 'L') { echo "onclick=Popup('module/bank/nasabah.Data.php?idbank=".$idbank."') disable placeholder='Klik disini untuk mengambil Data'"; }
							else{ echo "";}?>
						>
					</td>
				</tr>
