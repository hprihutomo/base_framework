       ...
       if(isset($_POST['submit'])){
            ...
            try{
                ...
                if($cari->rowCount()>0){
                    ...
                    echo "<i> Hasil pencarian dengan kata <b>\"".$_POST['txtsearch']."\"</b></i>, Jika Tidak Di Temukan <a href='javascript:void(0)' onclick=\"Popup('../../module/bank/create.nasabah.php?prdk=".$_GET['prdk']."', '', '800','700')\"> Klik disini</a> untuk tambah data <br>";
                    while($t=$cari->fetch()){
                    ?>
                ...
                <?php
                    ...
                    echo $cari->rowCount();
                    echo "<i> Tidak ada hasil untuk pencarian kata <b>\"".$_POST['txtsearch']."\" &nbsp;  </i></b><a href='javascript:void(0)' onclick=\"Popup('../../module/bank/create.nasabah.php?prdk=".$_GET['prdk']."', '', '800','700')\"> Klik disini</a> untuk tambah data";
                }
