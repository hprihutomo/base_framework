<table class="table table-condensed table-bordered">
	<thead>
		...
		<th class="text-center" width="200">PENGGUNAAN</th>
	...
	?>
		<tr>
			...
			<td align="center">
				<a href="javascript:void(0)" onclick="Popup('../bank/berkas.permohonan.php?id=<?php echo $data['IDPENJAMINAN'] ?>', '', '1300','700')" class="btn btn-warning btn-xs">
					<i class="fa fa-file"></i> 
					BERKAS
				</a>
				<a href="javascript:void(0)" onclick="Popup('../bank/upload.nasabah.php?id=<?php echo $data['IDPENJAMINAN'] ?>', '', '600','400')" class="btn btn-success btn-xs">
