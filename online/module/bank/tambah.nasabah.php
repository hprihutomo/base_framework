...
if (isset($_POST['create'])) {
	...
	if($value['JIWA']=='N'){
		...
		$pjiwa = $_POST['p_ijpjiwa'];
		$ijiwa = $_POST['ijpjiwa'];
	}


		$query = "INSERT INTO MSPENJAMINAN (IDUSER,USERNAME,IDPERMOHONAN,IDPRODUK,IDNASABAH,NOMOR_PK,TGL_PK,TARIFMAX,PLAFONDKREDIT,OUTSKREDIT,KODEPLAFOND,MASA,COVERAGE,IJPPERSEN,IJPJIWAPERSEN,IJP,TSB,IJPJIWA,JENISKREDIT,TENAGAKERJA,PENGHASILAN,PENGGUNAAN,DESKRIPSI)
									VALUES (:iduser,:username,:idpermohonan,:idproduk,:idnasabah,:nomorpk,:tglpk,:tarifmax,:plafond,:outkredit,:kode,:masa,:cov,:p_ijp,:p_ijpjiwa,:ijp,:TSB,:ijpjiwa,:jnskredit,:tenagakerja,:penghasilan,:penggunaan,:deskripsi)";
		$stmt = $db->prepare($query);
 ...
 <div class="panel panel-default">
	...
	<div class="panel-body">
		...
		<!-- <input type="hidden" id="idNasabah" name="idNasabah" autocomplete="off" value="<?php echo $auto_no; ?>"> -->
			<?php
				if ($value['JIWA']=='N') {
					include 'form.nasabah.php';
				}elseif($value['NAMAPRODUK']=='MULTIGUNA'){
					include 'form.nasabah.php';
				}elseif ($value['JIWA']=="Y") {
					include 'form.nasabah.jiwa.php';
				}
			?>
		<div class="row">
			<div class="col-lg-12">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<?php include 'daftar.nasabah.php'; ?>
			</div>
		</div>
	</div>
	</div>
