		...
		<table class='table table-bordered table-condensed' id="mytable">
	        ...
	        ?>
	            <tr>
	                ...
	                <td class="text-center">
	                	<?php //if ($value['STATUSPERMOHONAN']=='DRAFT') {?>
						<a href="javascript:void(0)" onclick="Popup('module/bank/tambah.nasabah.php?id=<?php echo $value['IDPERMOHONAN'] ?>', '', '1366','728')" class="btn btn-info btn-xs"><i class="fa fa-users"></i> NASABAH</a>
						<a href="javascript:void(0)" onclick="Popup('module/bank/kirim.permohonan.php?id=<?php echo $value['IDPERMOHONAN'] ?>', '', '1366','728')" class="btn btn-warning btn-xs"><i class="fa fa-send"></i> KIRIM</a>
						<?php //}elseif ($value['STATUSPERMOHONAN']=='PROSES') { ?>
