		...
		<table class='table table-bordered table-condensed mytable' ><!-- id="mytable" -->
	        ...
	        ?>
	            <tr>
	                ...
	                <td class="text-center">
	                	<a href="javascript:void(0)" onclick="Popup('module/manajemen/edit.bank.php?id=<?php echo $value['IDBANK'] ?>', '', '800','600')" class="btn btn-success btn-xs"><i class="fa fa-check"></i> EDIT</a>
	                	<a href="javascript:void(0)" onclick="Popup('module/manajemen/detail.bank.php?id=<?php echo $value['IDBANK'] ?>', '', '800','600')" class="btn btn-primary btn-xs"><i class="fa fa-file"></i> DETAIL</a>
