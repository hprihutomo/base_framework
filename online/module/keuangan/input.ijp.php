...
if (isset($_POST['simpan'])) {
  ...
  $update = "UPDATE MSPENJAMINAN SET IJPDITERIMA = :ijpditerima, IJPSELISIH = :ijpselisih, TGL_IJP_DITERIMA = :tglijpditerima, STATUSPENJAMINAN = '1' WHERE IDPENJAMINAN = :idpenjaminan";
