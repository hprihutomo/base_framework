	...
	<p> -->
		...
		<table class='table table-bordered table-condensed mytable' ><!-- id="mytable" -->
	        ...
	        <?php
	        	...
	        	$query = "SELECT * FROM CEK_IJP WHERE STATUSPENJAMINAN = '2'"; //IDPERMOHONAN = '".$_GET['id']."'
	   ...
	   <!--  <a href="javascript:void(0)" onclick="Popup('../../module/keuangan/kirim.php?id=<?php echo $value['IDPERMOHONAN'] ?>', '', '500','400')" class="btn btn-danger btn-xs"><i class="fa fa-certificate"></i> 
	                KIRIM</a>  -->
			</div>
		</div>
	</div>
