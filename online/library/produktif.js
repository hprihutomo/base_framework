$(document).ready(function(){
    ...
    if(masa <= 4){
         $('#p_ijpjiwa').val(0.50);
          ...
          $('#p_ijpjiwa').val(0.50); //1
       } else if(masa <= 24 ){
           $('#p_ijpjiwa').val(1.00); //2
       }else if(masa <= 36 ){
           $('#p_ijpjiwa').val(1.25); //3
       }else if(masa <= 48 ){
           $('#p_ijpjiwa').val(1.50); //4
       }else if(masa <= 60 ){
           $('#p_ijpjiwa').val(1.75); //5
       }else if(masa <= 72 ){
           $('#p_ijpjiwa').val(2.15); //6
       }else if(masa <= 84 ){
           $('#p_ijpjiwa').val(2.55); //7
       }else if(masa <= 96 ){
           $('#p_ijpjiwa').val(2.95); //8
       }else if(masa <= 108 ){
           $('#p_ijpjiwa').val(3.35); //9
       }else if(masa <= 120 ){
           $('#p_ijpjiwa').val(3.75); //10
       }
        ...
        var tarifjiwa    = parseFloat($('#p_ijpjiwa').val());
        var ijpjiwa      = plafond * tarifjiwa / 100;
