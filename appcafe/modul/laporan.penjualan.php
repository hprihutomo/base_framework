<div class="panel panel-primary">
  <div class="panel-body">
    ...
    <?php
      if (isset($_POST['cari'])) {
        $query = "SELECT * FROM body_transaksi WHERE tgltransaksi BETWEEN :awal AND :akhir";
        $quer = "SELECT SUM(subtotal) AS total FROM body_transaksi WHERE tgltransaksi BETWEEN :awal AND :akhir";
